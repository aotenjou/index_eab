...
\copy person_info from './person_info.csv' csv delimiter ',' null '' quote '"' header;
analyze person_info;
\copy info_type from './info_type.csv' csv delimiter ',' null '' quote '"' header;
analyze info_type;
\copy aka_title from './aka_title.csv' csv delimiter ',' null '' quote '"' header;
analyze aka_title;
\copy name from './name.csv' csv delimiter ',' null '' quote '"' header;
analyze name;
\copy movie_info_idx from './movie_info_idx.csv' csv delimiter ',' null '' quote '"' header;
analyze movie_info_idx;
\copy char_name from './char_name.csv' csv delimiter ',' null '' quote '"' header;
analyze char_name;
\copy company_name from './company_name.csv' csv delimiter ',' null '' quote '"' header;
analyze company_name;
\copy aka_name from './aka_name.csv' csv delimiter ',' null '' quote '"' header;
analyze aka_name;
\copy cast_info from './cast_info.csv' csv delimiter ',' null '' quote '"' header;
analyze cast_info;
\copy comp_cast_type from './comp_cast_type.csv' csv delimiter ',' null '' quote '"' header;
analyze comp_cast_type;
\copy company_type from './company_type.csv' csv delimiter ',' null '' quote '"' header;
analyze company_type;
\copy movie_link from './movie_link.csv' csv delimiter ',' null '' quote '"' header;
analyze movie_link;
\copy keyword from './keyword.csv' csv delimiter ',' null '' quote '"' header;
analyze keyword;
\copy title from './title.csv' csv delimiter ',' null '' quote '"' header;
analyze title;
\copy movie_info from './movie_info.csv' csv delimiter ',' null '' quote '"' header;
analyze movie_info;
\copy movie_keyword from './movie_keyword.csv' csv delimiter ',' null '' quote '"' header;
analyze movie_keyword;
\copy link_type from './link_type.csv' csv delimiter ',' null '' quote '"' header;
analyze link_type;
\copy complete_cast from './complete_cast.csv' csv delimiter ',' null '' quote '"' header;
analyze complete_cast;
\copy kind_type from './kind_type.csv' csv delimiter ',' null '' quote '"' header;
analyze kind_type;
\copy role_type from './role_type.csv' csv delimiter ',' null '' quote '"' header;
analyze role_type;
\copy movie_companies from './movie_companies.csv' csv delimiter ',' null '' quote '"' header;
