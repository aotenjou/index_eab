...
class DQN(OffPolicyRLModel):
    ...
    def setup_model(self):
        with SetVerbosity(self.verbose):
            ...
            with self.graph.as_default():
                ...
                # optimizer = tf.Adam(learning_rate=self.learning_rate)
    ...
    def predict(self, observation, state=None, mask=None, deterministic=True, action_mask=None):
        ...
        with self.sess.as_default():
            actions, _, _ = self.step_model.step(observation, action_mask=action_masks, deterministic=deterministic)
