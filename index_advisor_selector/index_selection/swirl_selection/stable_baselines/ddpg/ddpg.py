...
class DDPG(OffPolicyRLModel):
    ...
    def _train_step(self, step, writer, log=False):
        ...
        """
        # Get a batch
        obs, actions, rewards, next_obs, terminals = self.replay_buffer.pg_sample(batch_size=self.batch_size,
    ...
    def _adapt_param_noise(self):
        ...
        obs, *_ = self.replay_buffer.pg_sample(batch_size=self.batch_size, env=self._vec_normalize_env)
                    ...
                    for _ in range(log_interval):
                        ...
                        for _ in range(self.nb_rollout_steps):
                            ...
                            if np.random.rand() < self.random_exploration:
                                ...
                                unscaled_action = self.action_space.pg_sample()
