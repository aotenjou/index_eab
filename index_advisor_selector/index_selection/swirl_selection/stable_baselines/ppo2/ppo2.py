...
class Runner(AbstractEnvRunner):
    ...
    def _run(self):
        ...
        for _ in range(self.n_steps):
            ...
            # if clipped_actions[0] == 0 and \
            #         self.env.venv.valid_actions[clipped_actions[0]] != self.env.venv.action_manager.ALLOWED_ACTION:
            #     print(1)
            # infos[0]["action_mask"][0]
